    ...
    <div class="container-fluid">
        <div class="card mb-3">
            <div class="card-header">
                ...
                Mantenimiento Alumnos</div>
            <div class="card-body">
                <div class="table-responsive">
                    <a class="btn btn-primary" href="<?= site_url("Alumno_controller/mantenimientoAlumno/crear") ?>" style="margin-bottom:  2%">Crear nuevo</a>
                        ...
                        <tbody>
                            <?php foreach ($datos as $key => $value) : ?>
                                ...
                                <tr>
                                    ...
                                    <td class="td_telefono"><?= $value["telefono"] ?></td>
                                    <td id="td<?= $value["id"] ?>">
                                        <a href="<?= site_url("Alumno_controller/mantenimientoAlumno/editar/" . $value["id"]) ?>">Modificar</a>
                                        <a href="<?= site_url("Alumno_controller/mantenimientoAlumno/ver/" . $value["id"]) ?>">Ver</a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary" id="btn_borrar_id" href="<?= site_url("Alumno_controller/mantenimientoAlumno/borrar/") ?>">Borrar seleccionado</a>
            </div>
        </div>
    </div>
</div>
    ...
    function eligidoBorrar(id) {
        ...
        var tr = $("<tr/>", {
            ...
            html: '<td>' + $("#td" + id).siblings(".td_name").html() + '</td>\n\
                           ...
                           <td>' + $("#td" + id).siblings(".td_telefono").html() + '</td>'
