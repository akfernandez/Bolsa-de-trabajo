        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <a class="btn btn-primary" href="<?= site_url("Profesor_controller/mantenimientoProfesor/crear") ?>" style="margin-bottom:  2%">Crear nuevo</a>
                        ...
                        <tbody>
                            <?php foreach ($datos as $key => $value) : ?>
                                ...
                                <tr>
                                    ...
                                    <td id="td<?= $value["id"] ?>">
                                        <a href="<?= site_url("Profesor_controller/mantenimientoProfesor/editar/" . $value["id"]) ?>">Modificar</a>
                                        <a href="<?= site_url("Profesor_controller/mantenimientoProfesor/ver/" . $value["id"]) ?>">Ver</a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary" id="btn_borrar_id" href="<?= site_url("Profesor_controller/mantenimientoProfesor/borrar/") ?>">Borrar seleccionado</a>
            </div>
        </div>
    </div>
</div>
