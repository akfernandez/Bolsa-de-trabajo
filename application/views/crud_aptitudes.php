    ...
    <div class="container-fluid">
        <div class="card mb-3">
            <div class="card-header">
                ...
                Mantenimiento Aptitudes</div>
            <div class="card-body">
                <div class="table-responsive">
                    <a class="btn btn-primary" href="<?= site_url("Aptitud_controller/mantenimientoAptitud/crear") ?>" style="margin-bottom:  2%">Crear nuevo</a>
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            <?php foreach ($datos as $key => $value) : ?>
                                ...
                                <tr>
                                    <td class="td_descripcion"><?= $value["descripcion"] ?></td>
                                    <td class="td_familia"><?= $value["familia"] ?></td>
                                    <td id="td<?= $value["id"] ?>">
                                        <a href="<?= site_url("Aptitud_controller/mantenimientoAptitud/editar/" . $value["id"]) ?>">Modificar</a>
                                        <a href="<?= site_url("Aptitud_controller/mantenimientoAptitud/ver/" . $value["id"]) ?>">Ver</a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary" id="btn_borrar_id" href="<?= site_url("Aptitud_controller/mantenimientoAptitud/borrar/") ?>">Borrar seleccionado</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    function eligidoBorrar(id) {
        ...
        var tr = $("<tr/>", {
            ...
            html: '<td>' + $("#td" + id).siblings(".td_descripcion").html() + '</td>\n\
                   <td>' + $("#td" + id).siblings(".td_familia").html() + '</td>'
